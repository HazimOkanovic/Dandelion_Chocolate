exports.ShopPage = class ShopPage {
    ...
    async clickOnProduct(product){
        await this.page.locator("//div[@class='featured__collection--inner display-type--grid layout__type--grid hide-mobile']//div[@class='product-card-info']//a[@title ='"+product+"']").click()
    }
}